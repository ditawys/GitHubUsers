package com.f55121098.githubusers;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("list of Github_F55121098");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorizal", "token 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");
